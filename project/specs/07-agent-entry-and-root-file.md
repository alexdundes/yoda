...
5) Agent loads `yoda/todos/TODO.<dev>.yaml`, selects the highest-priority issue without dependencies using the canonical id, and follows the flow.
   - Bootstrap exception: if YAML is not available, load `yoda/todos/TODO.<dev>.md` (see `project/specs/15-bootstrap.md`).
