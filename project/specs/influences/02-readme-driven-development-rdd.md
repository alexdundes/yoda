...
* **MUST** provide a **single primary entrypoint** README for the framework (the “front door”) that answers: *what it is, why it exists, quickstart, and where the specs live*. ([Tom Preston-Werner][1])
