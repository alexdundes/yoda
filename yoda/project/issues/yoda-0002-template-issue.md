...
depends_on:
- yoda-0001
description: Align the issue templates in yoda/templates/ with the current specs and
  usage rules, ensuring they are ready for agents to use.
entrypoints: []
id: yoda-0002
lightweight: false
origin:
...
status: done
tags: []
title: Formalizar template de issue (normal e lightweight)
updated_at: '2026-01-27T13:32:33-03:00'
---

# yoda-0002 - Formalizar template de issue (normal e lightweight)
...
Issue: yoda-0002
Path: yoda/project/issues/yoda-0002-template-issue.md