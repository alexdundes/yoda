...
depends_on: []
description: Especificar o comportamento do `todo_update.py` e produzir a spec em
...
# yoda-0041 - Especificar script de atualizacao de TODO (todo_update.py)
<!-- AGENT: Replace yoda-0041 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Especificar script de atualizacao de TODO (todo_update.py) with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
