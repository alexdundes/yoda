...
depends_on:
- yoda-0002
description: Document how agents should create and fill issues using the templates
  under yoda/templates/.
entrypoints: []
id: yoda-0005
lightweight: false
origin:
...
status: done
tags: []
title: Template de issue (regras e uso)
updated_at: '2026-01-27T13:32:34-03:00'
---

# yoda-0005 - Template de issue (regras e uso)
...
Issue: yoda-0005
Path: yoda/project/issues/yoda-0005-template-issue-regras-uso.md