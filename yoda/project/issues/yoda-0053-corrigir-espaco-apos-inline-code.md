...
depends_on:
- yoda-0052
description: Adicionar um espaco apos inline-code em tres linhas do yoda/yoda.md para
  evitar colagem de texto e melhorar leitura.
entrypoints: []
id: yoda-0053
lightweight: false
origin:
...
# yoda-0053 - Corrigir espaco apos inline code no yoda.md
<!-- AGENT: Replace yoda-0053 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Corrigir espaco apos inline code no yoda.md with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
