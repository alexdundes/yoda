...
- Atualizar `yoda/yoda.md` com diretriz para agentes.
...
## Acceptance criteria
- [ ] Specs contem regra explicita e exemplos objetivos.
- [ ] `yoda/yoda.md` orienta agente a aplicar a regra ao abrir/executar issues de schema.
- [ ] Ha criterio claro para obrigatoriedade de migracao em `update.py`.
- [ ] Demais issues de alteracao de YAML podem referenciar esta politica sem ambiguidade.
