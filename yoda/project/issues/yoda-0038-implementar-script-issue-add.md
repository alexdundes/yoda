...
depends_on: []
description: Implementar o `issue_add.py` seguindo a spec definida em `project/specs/18-issue-add-script.md`.
entrypoints: []
id: yoda-0038
lightweight: false
origin:
...
# yoda-0038 - Implementar script de inclusao de issue (issue_add.py)
<!-- AGENT: Replace yoda-0038 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Implementar script de inclusao de issue (issue_add.py) with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
