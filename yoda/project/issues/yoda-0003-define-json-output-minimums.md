---
agent: Human
created_at: '2026-01-27T16:41:47-03:00'
depends_on: []
...
updated_at: '2026-01-27T16:41:47-03:00'
---
...
## Objective
Document the required JSON keys for each script and note that consumers must ignore unknown fields.

## Scope
- Add JSON output sections to the existing script specs.
...
## Acceptance criteria
- [ ] Specs document the minimal JSON keys for each script.
- [ ] Specs clarify forward-compatibility (ignore unknown keys).
