...
depends_on:
- yoda-0049
description: Remover a formatacao quebrada de backticks no meio do caminho TODO.<slug>.md
  em yoda/yoda.md, garantindo leitura e copia coerentes.
entrypoints: []
id: yoda-0050
lightweight: false
origin:
...
# yoda-0050 - Corrigir formatacao de caminho TODO.<slug>.md
<!-- AGENT: Replace yoda-0050 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Corrigir formatacao de caminho TODO.<slug>.md with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
