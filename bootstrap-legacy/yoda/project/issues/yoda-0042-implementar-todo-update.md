...
depends_on: []
description: Implementar o `todo_update.py` seguindo a spec definida em `project/specs/20-todo-update-script.md`.
entrypoints: []
id: yoda-0042
lightweight: false
origin:
...
# yoda-0042 - Implementar script de atualizacao de TODO (todo_update.py)
<!-- AGENT: Replace yoda-0042 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Implementar script de atualizacao de TODO (todo_update.py) with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
