...
depends_on:
- yoda-0037
description: Documentar no bootstrap que issues antigas podem nao ter YAML front matter,
  enquanto novas issues devem seguir o padrao atual. Isso elimina ambiguidade sem
  backfill.
entrypoints: []
id: yoda-0048
lightweight: false
...
# yoda-0048 - Resolver inconsistencias de front matter nas issues antigas
<!-- AGENT: Replace yoda-0048 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Resolver inconsistencias de front matter nas issues antigas with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
