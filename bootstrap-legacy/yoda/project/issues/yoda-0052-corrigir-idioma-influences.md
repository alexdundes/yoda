...
depends_on:
- yoda-0051
description: Substituir frases em portugues nos arquivos de influences por equivalentes
  em ingles para manter a politica de idioma das specs.
entrypoints: []
id: yoda-0052
lightweight: false
origin:
...
# yoda-0052 - Corrigir trechos em portugues nos influences
<!-- AGENT: Replace yoda-0052 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Corrigir trechos em portugues nos influences with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
