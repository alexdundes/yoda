...
depends_on:
- yoda-0007
description: Define collaboration rules for multi-developer YODA usage, including
  TODO conflicts, cross-dependencies, and branch conventions. The goal is to ensure
  consistent behavior when multiple devs are active. This removes ambiguity for team
  workflows.
entrypoints: []
id: yoda-0013
lightweight: false
...
priority: 6
schema_version: '1.0'
slug: colaboracao-multi-dev
status: done
tags: []
title: Colaboracao multi-dev
updated_at: '2026-01-27T13:32:36-03:00'
---

# yoda-0013 - Define multi-dev collaboration rules
...
Issue: yoda-0013
Path: yoda/project/issues/yoda-0013-colaboracao-multi-dev.md