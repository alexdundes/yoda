...
depends_on: []
description: Atualizar specs e `todo_update.py` para copiar metadados do TODO para
  o front matter da issue a cada update.
entrypoints: []
id: yoda-0044
lightweight: false
origin:
...
updated_at: '2026-01-27T13:32:43-03:00'
---

# yoda-0044 - Sincronizar front matter ao atualizar TODO (todo_update.py)
<!-- AGENT: Replace yoda-0044 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Sincronizar front matter ao atualizar TODO (todo_update.py) with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
