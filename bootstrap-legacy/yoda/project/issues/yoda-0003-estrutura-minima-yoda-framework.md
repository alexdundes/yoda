...
depends_on:
- yoda-0001
description: Define and document the minimum folder and file structure for a YODA
  Framework project.
entrypoints: []
id: yoda-0003
lightweight: false
...
priority: 8
schema_version: '1.0'
slug: estrutura-minima-yoda-framework
status: done
tags: []
title: Estrutura minima do YODA Framework
updated_at: '2026-01-27T13:32:33-03:00'
---

# yoda-0003 - Estrutura minima do YODA Framework
...
Issue: yoda-0003
Path: yoda/project/issues/yoda-0003-estrutura-minima-yoda-framework.md