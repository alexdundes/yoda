...
depends_on: []
description: Atualizar specs e scripts para logs detalhados, com campos alterados
  e dados iniciais informados.
entrypoints: []
id: yoda-0043
lightweight: false
origin:
...
# yoda-0043 - Melhorar rastreabilidade dos logs dos scripts
<!-- AGENT: Replace yoda-0043 with the canonical issue id (dev-id, e.g., yoda-0001) from `yoda/todos/TODO.<dev>.yaml` and Melhorar rastreabilidade dos logs dos scripts with the issue title. Fill front matter fields from TODO; scripts must keep them in sync. Keep any <...> placeholders wrapped in inline code when used in prose. -->
