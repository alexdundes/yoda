...
- yoda-0007
- yoda-0008
description: Define the minimal validation and checks required for YODA artifacts
  (TODO, issues, logs). The goal is to document what must be validated and when. This
  removes ambiguity for future validation tooling.
entrypoints: []
id: yoda-0011
lightweight: false
origin:
...
priority: 7
schema_version: '1.0'
slug: validacao-checks-minimos
status: done
tags: []
title: Validacao e checks minimos
updated_at: '2026-01-27T13:32:35-03:00'
---

# yoda-0011 - Define minimal validation and checks
...
Issue: yoda-0011
Path: yoda/project/issues/yoda-0011-validacao-checks-minimos.md